    ...
    <div id="id01" class="modal">
      ...
      <h3>  <b> <u> Add new farmer</u></b> </h3>
        <div class="container">
                ...
                <input type="text" name="ph" value="" placeholder="Phone Number" required/>
                <br>
                <label for="vid">village id<sup>*</sup> </label>
                <input type="text" name="vid" value="" placeholder="address" required/>
                <br>
                ...
                <input type="number" name="min_litre" value="" placeholder="/day" required/>
                <br>
                <label for="animalID">Animal Health ID<sup>*</sup> </label>
                <input type="text" name="animalID" value="" placeholder="Issued by Health Ministry" required/>
                <br>
...
function edit()
{
  ...
  modal1.style.display='block';
      ...
      */
      ...
      $('#ph').val(data[2]);
      $('#f_vid').val(data[3]);
      $('#milk_type').val(data[4]);
      $('#min_litre').val(data[5]);
      $('#animalID').val(data[6]);
