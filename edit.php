...
$sql = "UPDATE farmer SET id=$id,fname='$firstname',ph='$ph',f_vid='$f_vid',milk_type='$milk_type',min_litre='$min_litre',animalID='$animalID' WHERE id=$idupdate";
...
?>
      ...
      <h3>  <b> <u>Update Customer Details</u></b> <a class="delete-icon" href="farmer.php">  <i class="fas fa-arrow-circle-left"></i></a> </h3>
        <div class="container">
                ...
                <input type="text" name="ph" value=" <?php echo $arrdata['ph']; ?>" placeholder="Phone Number" required/>
                <br>
                <label for="f_vid">Village ID<sup>*</sup> </label>
                <input type="number" name="f_vid" value="<?php echo $arrdata['f_vid']; ?>" placeholder="Village ID" required/>
                <br>
                ...
                <input type="text" name="animalID" value="<?php echo $arrdata['animalID']; ?>" placeholder="Issued by Health Ministry" required/>
                <br>
