  ...
  <head>
    ...
    function computeCost() {
      ...
      // Compute the cost
        ...
        totalCost = $MILK * 19.25+ $CURD * 20 + $GHEE * 400 + $CHEESE * 410 + $BUTTER * 510;
      }
...
<ul class="list">
  ...
  <!-- Now, the table data entries -->
          ...
          <tr>
            ...
            <th> MILK 1 L</th>
            <td><i class="fas fa-rupee-sign"></i> 19.25 </td>
            <td> <label for="id_1"> <input type="Checkbox" name="id_1" value="204"/>   204</label> </td>
          ...
          <tr>
            ...
            <th> curd 1 L</th>
            <td><i class="fas fa-rupee-sign"></i> 20 </td>
