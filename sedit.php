    ...
    ?>
      ...
      <h3>  <b> <u> Update Staff details</u></b>  <a class="delete-icon" href="staff.php">  <i class="fas fa-arrow-circle-left"></i></a></h3>
        <div class="container">
                ...
                <input type="text" name="ename" value="<?php echo $arrdata['ename']; ?>" placeholder="first name" required/>
                <br>
                <label for="phonenumber">Phone number<sup>*</sup> </label>
                <input type="text" name="phno" value="<?php echo $arrdata['phno']; ?>" placeholder="Phone Number" required/>
                <br>
